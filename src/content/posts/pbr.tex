...
\usepackage{amssymb}
\usepackage{graphicx}
% pdflatex resolves figures through this; pandoc ignores it and emits the
% bare path, which the loader rewrites to <base>/figures/<path>.
\graphicspath{{../../../public/figures/}}

\title{Physically-based Rendering}
\subtitle{I discuss Cook-Torrance BRDF, and my challenges in implementing a working physically-based renderer. I also sprinkle in the addition of multiscattering IBL.}
